...
| [Flipping a URL flag's default](spoiler-free-default-on.md) | 2026-07-26 | Spoiler-free defaults on, so the link must carry the opt-out — and two ways that goes silently wrong |
